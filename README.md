...
- 🔗 [`docs/QUELLEN.md`](docs/QUELLEN.md) — **every source in one place**: projects, tools, standards, findings, and seven recurring failure patterns with evidence and countermeasure (German)
