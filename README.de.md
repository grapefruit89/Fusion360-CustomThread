...
- 🔗 [`docs/QUELLEN.md`](docs/QUELLEN.md) — **alle Quellen an einer Stelle**: Projekte, Werkzeuge, Normen, Fundstellen und die sieben wiederkehrenden Fehlermuster mit Beleg und Gegenmaßnahme
